    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div class="flex justify-center">
                <Pagination v-slot="{ page }" @update:page="setPage" :items-per-page="records.meta.per_page" :total="records.meta.total" :sibling-count="1" show-edges :default-page="records.meta.current_page">
